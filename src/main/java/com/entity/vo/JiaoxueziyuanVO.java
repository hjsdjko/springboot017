...
public class JiaoxueziyuanVO  implements Serializable {
	...
	public void setZiyuanwendang(String ziyuanwendang) {
		this.ziyuanwendang = ziyuanwendang;
	}
	
	/**
	 * 获取：资源文档
	 */
	public String getZiyuanwendang() {
		return ziyuanwendang;
	}
