...
public class TijiaozuoyeServiceImpl extends ServiceImpl<TijiaozuoyeDao, TijiaozuoyeEntity> implements TijiaozuoyeService {
    ...
    @Override
    public List<Map<String, Object>> xingmingzhuangtaiTypeStat(Map<String, Object> params, Wrapper<TijiaozuoyeEntity> wrapper) {
        return baseMapper.xingmingzhuangtaiTypeStat(params, wrapper);
    }
